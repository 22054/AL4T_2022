...
/**
 * Focused tests for Mario's basic stats and form flags.
 * Replaces the legacy Unit_test class with clearer naming and JUnit 5 + AssertJ.
 */
public class MarioStatsTest {
